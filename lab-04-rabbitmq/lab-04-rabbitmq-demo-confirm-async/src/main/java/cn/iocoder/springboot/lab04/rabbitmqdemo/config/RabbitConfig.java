...
public class RabbitConfig {
    ...
    /**
     * 指定消息转换器为JSON转换器{@link org.springframework.amqp.support.converter.Jackson2JsonMessageConverter }
     * 默认的消息转换器 {@link org.springframework.amqp.support.converter.SimpleMessageConverter }
     * 源码见 {@link org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration }
     *
     * @return
     */
    @Bean
